    ...
    return rep.send({
      ...
      data: {
        ...
        config: {
          ...
          principalName: config.showPrincipalMessage ? config.principalName : null,
          principalMessage: config.showPrincipalMessage ? config.principalMessage : null,
          ...
          virtualTourUrl: config.virtualTourUrl,
          ...
          showPrincipalMessage: config.showPrincipalMessage,
          showFacilities: config.showFacilities,
          showFAQs: config.showFAQs,
          ...
          facilities: config.showFacilities ? config.facilities : [],
          faqs: config.showFAQs ? config.faqs : [],
        },
        notices,
      },
    });
